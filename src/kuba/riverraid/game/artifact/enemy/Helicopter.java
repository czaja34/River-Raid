...
/**
 * @author jakub klasa odpowiedzialna za obiekt helikopter
 */
public class Helicopter extends MovingElement {
	...
	public Helicopter(Background backGround, int x, int y) {
		super(x, y);
